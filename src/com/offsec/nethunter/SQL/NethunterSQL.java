...
public class NethunterSQL extends SQLiteOpenHelper {
    ...
    private static final String[][] nethunterData = {
            ...
            {"7", "Network Interface Status", " ip -o addr show | /data/data/com.offsec.nethunter/scripts/bin/busybox_nh awk '{print $2, $3, $4}'", "\\n", "1"},
            {"8", "External IP", "/data/data/com.offsec.nethunter/scripts/bin/busybox_nh which wget > /dev/null 2>&1 && /data/data/com.offsec.nethunter/scripts/bin/busybox_nh wget -qO - icanhazip.com || curl -s ipv4.icanhazip.com", "\\n", "0"}
    };
